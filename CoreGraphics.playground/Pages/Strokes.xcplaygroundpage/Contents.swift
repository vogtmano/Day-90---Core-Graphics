...
let rendered = renderer.image { ctx in
    ...
    let smallCircle1 = CGRect(x: 150, y: 200, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: smallCircle1)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let smallCircle2 = CGRect(x: 650, y: 200, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: smallCircle2)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let smallCircle3 = CGRect(x: 150, y: 600, width: 200, height: 200)
    ctx.cgContext.addEllipse(in: smallCircle3)
    ctx.cgContext.drawPath(using: .fillStroke)
    
    let smallCircle4 = CGRect(x: 650, y: 600, width: 200, height: 200)
